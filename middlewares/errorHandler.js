...
const errorHandler = (err, req, res, next)=>{
    ...
    if(customError.msg.includes('.filter is not a function') || customError.msg.includes('.map is not a function')){
        customError.msg = 'Please provide values in correct format, (Array Of objects)';
